    ...
    def test_text_after_para(self):
        ...
        self.assertEqual(
            ...
            convert_html_to_telegraph_format(
                html, output_format="html_string", clean_html=True
            ),
        )
...
<div>
    ...
    def test_figure_inside(self):
        html_figure_inside = (
            "<div><figure>Some figure content</figure><p>paragraph text</p></div>"
        )
        self.assertJson(
            [
    ...
    def test_figure_inside_with_img(self):
        html_figure_inside_with_img = (
            '<div><figure>Some figure content <img src="image.png"/></figure></div>'
        )
        self.assertJson(
            [
                {
    ...
    def test_br_tags_two(self):
        html = (
            '<br><br /> <br clear="someoldattribute">  <div>' "</div> <br/> text <br>"
        )
        self.assertJson(
            [{"children": ["\ntext \n"], "tag": "p"}],
            convert_html_to_telegraph_format(html, clean_html=True),
    ...
    def test_blockquote_para_strong(self):
        quote_para_strong = (
            "<blockquote><p>first para</p><strong>strong text</strong></blockquote>"
        )
        self.assertJson(
            [
                {
                    "children": [
                        "first para\n",
                        {"children": ["strong text"], "tag": "strong"},
                    ],
                    "tag": "blockquote",
                }
            ],
    ...
    def test_blockquote_inside_figure(self):
        quote_inside_figure = (
            "<figure><blockquote>Blockquote text inside figure</blockquote></figure>"
        )
        self.assertJson(
            ...
            [
                {
                    "tag": "figure",
                    "children": [
                        {"tag": "figcaption", "children": ["Telegram\nText after link"]}
                    ],
                }
            ],
            convert_html_to_telegraph_format(
                figcaption_para_with_link, clean_html=True
            ),
        )
    ...
    def test_bad_para_inside_blockquote_with_empty_em(self):
        ...
        self.assertJson(
            [{"children": ["first para"], "tag": "blockquote"}],
    ...
    def test_convert_without_clean(self):
        ...
        self.assertJson(
            [
                {"tag": "p", "children": ["Text first line"]},
                {"tag": "br"},
                {"tag": "br"},
                {"tag": "br", "attrs": {"class": "somebrclass"}},
                {"tag": "div"},
                {"tag": "br", "attrs": {"id": "somebrid"}},
                {"tag": "p", "children": ["text"]},
                {"tag": "br"},
                {
                    "tag": "span",
            ...
            [
                {
                    ...
                    "children": [
                        {
                            "tag": "img",
                            "attrs": {"src": "http://httpbin.org/image/jpeg"},
                        }
                    ],
                }
            ],
    ...
    def test_duplicated_bad_tags(self):
        ...
        self.assertJson(
            [
                {
                    "children": [{"children": ["Text"], "tag": "figcaption"}],
                    "tag": "figure",
                }
            ],
    ...
    def test_json_to_html(self):
        ...
        json_text = (
            '[{"tag":"p","children":["First paragraph text (текст).\\nSecond string "]},'
        ...
        html_text = (
            "<p>First paragraph text (текст).<br/>Second string </p><p>Next paragraph</p><figure>"
            '<img src="http://graph.org/file/d12da8bd435240bc3c6d2.jpg"><figcaption>Test girl with cat</figcaption>'
            "</figure><ul><li><strong>Unordered </strong>list first item</li><li><em>Unordered </em>list "
            '<a href="http://graph.org/">second </a>item</li></ul>'
...
class TelegraphConversionIframeTest(JSONAssertion):
    def setUp(self):
        self.iframe_with_text = (
            '<iframe src="//www.youtube.com/embed/abcdef">legacy text</iframe>'
        )
    ...
    def test_iframe_text_after(self):
        iframe_text_after = (
            '<p><iframe src="//www.youtube.com/embed/abcdef"></iframe>Text after </p>'
        )
        self.assertJson(
            [
                {
    ...
    def test_iframe_mix(self):
        mix = (
            self.iframe_child_no_src
            + self.iframe_with_text
            + self.iframe_empty_src
            + self.iframe_no_src
        )
        self.assertJson(
            [
            ...
            [
                {
                    ...
                    "children": [
                        "Text before",
                        {"tag": "a", "attrs": {"href": "/123"}, "children": ["link"]},
                    ],
                },
                {
                    "tag": "figure",
                ...
                },
                {
                    ...
                    "children": [
                        " text",
                        {"tag": "a", "attrs": {"href": "/246"}, "children": ["link2"]},
                        " Text after link",
                    ],
                },
                {
            ...
            [
                {
                    ...
                    "children": [
                        "Text before ",
                        {"tag": "code", "children": [" inline_code = True"]},
                        " Text after",
                    ],
                },
                {
...
class TelegraphConversionImagesTest(JSONAssertion):
    ...
    def test_image_inside_paragraph(self):
        html = (
            '<p> <img src="image0.jpg"/></p>'
            '<p>  <span> <img src="image1.jpg"/>   </span> <img src="image2.jpg"/> </p>'
        )
        self.assertJson(
            [
                {
                    "children": [{"attrs": {"src": "image0.jpg"}, "tag": "img"}],
                    "tag": "figure",
                },
                {
                    "children": [{"attrs": {"src": "image1.jpg"}, "tag": "img"}],
                    "tag": "figure",
                },
                {
                    "children": [{"attrs": {"src": "image2.jpg"}, "tag": "img"}],
                    "tag": "figure",
                },
            ],
            convert_html_to_telegraph_format(html, clean_html=True),
    ...
    def test_image_inside_paragraph_with_text(self):
        ...
        self.assertJson(
            [
                ...
                {
                    "tag": "figure",
                    "children": [{"tag": "img", "attrs": {"src": "image1.jpg"}}],
                },
                {"tag": "p", "children": ["xyz "]},
            ],
    ...
    def test_image_inside_paragraph_with_figure_para_after(self):
        html = (
            '<p>Text 1 <figure> <img src="image0.jpg"/> <figcaption><em>test</em></figcaption></figure> </p>'
            "<p>Text 2<p>"
        )
        self.assertJson(
            [
    ...
    def test_image_inside_paragraph_without_figure_para_after(self):
        ...
        self.assertJson(
            [
                ...
                {
                    "tag": "figure",
                    "children": [{"tag": "img", "attrs": {"src": "image0.jpg"}}],
                },
                {"tag": "p", "children": ["Text after image "]},
                {"tag": "p", "children": ["Text 2 "]},
            ],
            convert_html_to_telegraph_format(html, clean_html=True),
        )
    ...
    def test_image_tag_at_the_top(self):
        ...
        self.assertJson(
            [
                {
                    "children": [{"attrs": {"src": "image.jpg"}, "tag": "img"}],
                    "tag": "figure",
                }
            ],
            convert_html_to_telegraph_format(html, clean_html=True),
    ...
    def test_image_html_with_text_after(self):
        self.assertJson(
            ...
            convert_html_to_telegraph_format(
                self.html_with_text_after, clean_html=True
            ),
        )
    ...
    def test_image_html_with_text_before(self):
        self.assertJson(
            ...
            convert_html_to_telegraph_format(
                self.html_with_text_before, clean_html=True
            ),
        )
...
class TelegraphConversionTwitterLinksTest(JSONAssertion):
    ...
    def test_twitter_links(self):
        ...
        """
        self.assertJson(
            self.assert_with, convert_html_to_telegraph_format(html, clean_html=True)
        )
    ...
    def test_twitter_links_duplicated_link(self):
        ...
        self.assertJson(
            self.assert_with,
            convert_html_to_telegraph_format(duplicated_link_html, clean_html=True),
        )
